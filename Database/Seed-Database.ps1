...
INSERT INTO user_accounts ("Id", "Username", "Email", "PasswordHash", "FullName", "PhoneNumber", "Role", "Status", "CreatedAt", "IsDeleted")
VALUES
    (1, 'admin_demo', 'admin@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Nguyen Van Admin', '0900000001', 'Administrator', 'LoggedIn', NOW() - INTERVAL '60 days', false),
    (2, 'parent_demo1', 'parent1@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Tran Thi Hoa', '0900000002', 'Parent', 'EmailVerified', NOW() - INTERVAL '55 days', false),
    (3, 'parent_demo2', 'parent2@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Nguyen Van Binh', '0900000003', 'Parent', 'LoggedIn', NOW() - INTERVAL '52 days', false),
    (4, 'parent_demo3', 'parent3@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Le Thi Cuc', '0900000004', 'Parent', 'EmailVerified', NOW() - INTERVAL '50 days', false),
    (5, 'parent_demo4', 'parent4@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Pham Van Dung', '0900000005', 'Parent', 'Suspended', NOW() - INTERVAL '48 days', false),
    (6, 'parent_demo5', 'parent5@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Hoang Thi Em', '0900000006', 'Parent', 'Registered', NOW() - INTERVAL '46 days', false),
    (7, 'teacher_demo1', 'teacher1@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Vu Van Phong', '0900000007', 'Teacher', 'LoggedIn', NOW() - INTERVAL '45 days', false),
    (8, 'teacher_demo2', 'teacher2@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Do Thi Giang', '0900000008', 'Teacher', 'EmailVerified', NOW() - INTERVAL '44 days', false),
    (9, 'teacher_demo3', 'teacher3@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Bui Van Hai', '0900000009', 'Teacher', 'PasswordResetPending', NOW() - INTERVAL '43 days', false),
    (10, 'teacher_demo4', 'teacher4@example.com', '$2a$11$uQ6RWu9dJN87HUij5gy3RedTZUibH1T4BB/QZBmvLntZBvkjQIR0S', 'Dang Thi Kim', '0900000010', 'Teacher', 'LoggedOut', NOW() - INTERVAL '42 days', false)
