...
/// <summary>
/// Gemini multimodal alignment evaluator — checks whether a generated illustration faithfully
/// represents the story scene text and visual description.
///
/// Uses the text-only Gemini model (gemini-2.5-flash) to avoid image generation cost during evaluation.
/// Reads alignment score from structured JSON response: { "alignmentScore": 0.0-1.0, "reason": "..." }
/// </summary>
